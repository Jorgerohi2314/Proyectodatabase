...
export function LaboralYearNavbar({ users, onFilterChange, activeFilter }: LaboralYearNavbarProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
      <div className="px-3 py-2.5 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
              ...
              return (
                <li key={year} className={cn(isActive && "bg-blue-50 dark:bg-blue-900/20")}>
                  <button
                    ...
                    className="w-full px-3 py-2 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors text-left"
                  >
                      ...
                      {yearUsers.map((user) => (
                        <li key={user.id}>
                          <button
                            ...
                            className={cn(
                              "w-full px-3 py-2 flex items-center gap-3 text-left hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors",
